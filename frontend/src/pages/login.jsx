  ...
  return (
    <form className="flex flex-col gap-3.5 w-[50%] p-5 rounded-2xl relative bg-transparent text-white border-[#333]">
      ...
      <p className="text-[28px] font-semibold tracking-[-1px] relative flex items-center pl-7.5 text-slate-400">
        ...
        <span className="bg-linear-to-r from-slate-500 to-slate-400 font-bold text-transparent bg-clip-text">
          Login
        </span>
      </p>

      <p className="text-[14.5px] text-white/70">
        Login now and continue chatting with your friends.
      </p>
      ...
      <label className="relative">
        ...
        <span
          className="absolute left-2.5 top-3 text-[0.9em] text-white/50 transition-all duration-300
